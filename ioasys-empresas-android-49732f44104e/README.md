...
implementaria o buscar corretamente porque não esta vindo nada do servidor de vocês quando puxo pelo postman o endPoint de pesquisa
Faria recuperar senha, mostrar foto do usuario, deslogar, menu com informções, tela inicial tiraria aquele texto e colocaria umas imagens
cas empresas em um carrossel, montaria uma tela splash, mudaria o nome do app de instalação e colocaria um icon.

unica coisa quando for executar na tela incial coloquei pra salvar os dados localmente e se nao quiser ficar logando sempre voce so precisaria de 
descomentar umas 3 linhas e pronto, unico problema que como o token tem validade ai precisaria de gerar ele novamente.